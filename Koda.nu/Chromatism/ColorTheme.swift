...
public enum ColorTheme {
    ...
    private static let duskTheme: [JLTokenType: UIColor] = [
        ...
        .documentationComment:         UIColorRGB(0, g: 75, b: 204),
        .documentationCommentKeyword:  UIColorRGB(0, g: 75, b: 204),
        .string:                       UIColorRGB(230, g: 66, b: 75),
        .character:                    UIColorRGB(172, g: 13, b: 3),
        .number:                       UIColorRGB(8, g: 103, b: 67),
        .keyword:                      UIColorRGB(230, g: 0, b: 238),
        .preprocessor:                 UIColorRGB(198, g: 124, b: 72),
        .url:                          UIColorRGB(230, g: 66, b: 75),
